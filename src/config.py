...
# CVES_MAPPED_W_COMMITS_DIR is the path to project_info.csv, which contains the mapping of vulnerabilities to projects.
...
# This values should match qlpacks/codeql/cpp-queries/{CODEQL_QUERY_VERSION}
CODEQL_QUERY_VERSION = "0.8.3"
